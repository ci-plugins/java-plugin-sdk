...
public class OkHttpUtils {
  ...
  private static OkHttpClient createClient(
    ...
    if (connectTimeout > 0) finalConnectTimeout = connectTimeout;
    if (writeTimeout > 0) finalWriteTimeout = writeTimeout;
    if (readTimeout > 0) finalReadTimeout = readTimeout;
  ...
  public static String doPost(
      String url, String jsonParam, long connectTimeout, long writeTimeout, long readTimeout) {
  ...
  public static String doDelete(
      String url, long connectTimeout, long writeTimeout, long readTimeout) {
  ...
  public static String doHttp(
      Request request, long connectTimeout, long writeTimeout, long readTimeout) {
