...
public class ArtifactoryApi extends BaseApi {
  ...
  public Result<List<String>> getArtifactoryFileUrl(String artifactoryType, String path) {
    StringBuilder urlBuilder =
        new StringBuilder(
            "/artifactory/api/build/artifactories/thirdPartyDownloadUrl?artifactoryType=");
    urlBuilder
        .append(artifactoryType)
        .append("&path=")
        .append(path)
        .append("&ttl=")
        .append(3600); // 下载链接有效期设定为1小时
    ...
    if (null != responseContent) {
      Result<List<String>> srcUrlResult =
          JsonUtil.fromJson(responseContent, new TypeReference<Result<List<String>>>() {});
   ...
   */
  @SuppressWarnings("all")
  public Result<List<String>> downloadArtifactoryFileToLocal(
      String artifactoryType, String path, String saveDir) {
    ...
    logger.info(
        "downloadArtifactoryFileToLocal saveFilePathList is:{}", JsonUtil.toJson(saveFilePathList));
    return new Result(saveFilePathList);
  }
  ...
  public Result<List<FileDetail>> getArtifactsProperties(String artifactoryType, String path) {
    StringBuilder urlBuilder =
        new StringBuilder(
            "/artifactory/api/build/artifactories/getPropertiesByRegex?artifactoryType=");
    ...
    if (null != responseContent) {
      Result<List<FileDetail>> srcUrlResult =
          JsonUtil.fromJson(responseContent, new TypeReference<Result<List<FileDetail>>>() {});
      if (srcUrlResult == null) {
        logger.info("no ArtifactoryFileUrl is found");
        return new Result(null);
      }
      ...
      logger.info(
          "getArtifactoryProperties responseContent is:{}", JsonUtil.toJson(fileDetailList));
