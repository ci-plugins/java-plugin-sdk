...
public class JsonUtil {
  ...
  public static <T> String skipLogFields(T bean) {
    return jsonMappers
        .computeIfAbsent(
            "__skipLogFields__" + bean.getClass().getName(),
            (String s) -> {
              ...
              if (!skipFields.isEmpty()) {
                ...
                FilterProvider filterProvider =
                    new SimpleFilterProvider()
                        .addFilter(
                            SkipLogField.class.getAnnotation(JsonFilter.class).value(),
  ...
  public static <T> T fromJson(String jsonString, TypeReference<T> typeReference) {
    return jsonMappers
        .computeIfAbsent("__all__", s -> JsonMapper.allOutPutMapper())
        .fromJson(jsonString, typeReference);
  }
  ...
  public static <T> String toNonEmptyJson(T bean) {
    return jsonMappers
        .computeIfAbsent("__non_empty__", s -> JsonMapper.nonEmptyMapper())
        .toJson(bean);
  }
}
